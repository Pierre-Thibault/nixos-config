module git.pierrethibault.dev/nixos-config/custom-caddy

go 1.26

require (
	git.pierrethibault.dev/nixos-config/ovhsign v0.0.0
...
replace git.pierrethibault.dev/nixos-config/ovhsign => ../ovhsign
